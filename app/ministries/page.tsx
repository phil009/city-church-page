...
import JoinUnitForm from "@/components/ministries/form";
import MinistriesCarousel from "@/components/ministries/ministries-carousel";
...
// Flatten all ministries into a single array
const allMinistries = ministries.flatMap((ministry) => ministry.subcategories);
    ...
    return (
        <section className="before:block before:h-12">
            ...
            <div className="mx-auto px-4 py-12 relative">
                ...
                />
                <div className="bg-appDark/50 w-full h-full absolute inset-0" />
                <div className="grid lg:grid-cols-2 gap-8 items-start relative">
                    ...
                    <div className="lg:sticky lg:top-24 hidden lg:block">
                        <MinistriesCarousel ministries={allMinistries} />
                    </div>
                </div>
            </div>
        </section>
