...
export default function HowItWorks() {
  const steps = [
    ...
    },
    {
      title: "Click Join",
      description:
        "When you find a group you're interested in, click the 'Join WhatsApp Group' button.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-white"
    ...
    },
    {
      title: "Get Connected",
      description:
        "The group leader will welcome you and you'll get to know other group members as well as details of the meetings.",
      icon: (
        <svg
          xmlns="http://www.w3.org/2000/svg"
          className="h-8 w-8 text-white"
