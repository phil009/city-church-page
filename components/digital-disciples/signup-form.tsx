        ...
        <section className="px-4 sm:px-12 md:px-20 py-14 bg-appOffWhite">
            ...
            >
                ...
                <p className="text-sm md:text-base opacity-65 mb-10">
                    Pick the role that fits your gifting and commit to making
                    City Church&apos;s digital mission count.
                </p>
                ...
                {submitted ? (
                    ...
                    >
                        ...
                        <h3 className="text-2xl font-bold text-appDark mb-2">
                            You&apos;re in!
                        </h3>
                        <p className="text-sm opacity-65 mb-6">
                            Thank you for signing up. The Socials Team will
                            reach out with your onboarding details soon.
                        </p>
                        <Button
                                ...
                                >
                                    ...
                                    >
                                        ...
                                        {step === 1 && (
                                            <>
                                                <div>
                                                    <h3 className="text-lg font-semibold text-appDark">
                                                        Personal Info
                                                    </h3>
                                                                ...
                                                                {ROLES.map(
                                                                    (r) => (
                                                                        ...
                                                                        >
                                                                            ...
                                                                            <div>
                                                                                <p className="font-semibold text-appDark">
                                                                                    {
                                                                                        r.label
                                                                                    }
                                                                                </p>
                                                                                <p className="text-xs opacity-60 mt-0.5 leading-snug">
                                                                                    {
                                                                                        r.description
                                                                                    }
                                                                                </p>
                                                        ...
                                                        <FormItem>
                                                            ...
                                                            >
                                                                ...
                                                                <SelectContent>
                                                                    ...
                                                                    <SelectItem value="A few times a week">
                                                                        A few
                                                                        times a
                                                                        week
                                                                    </SelectItem>
                                        ...
                                        {step === 4 && (
                                            <>
                                                <div>
                                                    ...
                                                    <p className="text-xs opacity-50 mt-0.5">
                                                        Every Digital Disciple
                                                        represents the church.
                                                    </p>
                                                </div>

                                                <div className="bg-appOffWhite rounded-xl p-5 border border-appGhost text-sm leading-relaxed text-appDark opacity-80">
                                                    As a Digital Disciple, my
                                                    online presence will reflect
                                                    the values and integrity of
                                                    City Church. I will engage
                                                    respectfully, share
                                                    truthfully, and represent
                                                    the Kingdom well in every
                                                    space.
                                                </div>
